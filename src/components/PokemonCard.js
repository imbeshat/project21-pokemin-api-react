		...
		<>
			{!data
				...
				: data.map((pokemon) => {
						return (
							<>
								<div className="mx-auto rounded-2xl bg-slate-800 p-2 flex flex-col items-center">
									...
									<div className="w-[60%] flex flex-col md:flex-row items-center justify-between my-4">
										<img className="w-[180px] md:w-[300px]" src={pokemon.sprites.other.dream_world.front_default} alt={pokemon.name} />
										<div className="text-left">
											<h2 className="text-2xl my-3">Pokemon Stats: </h2>
											<h3>
												Height: {pokemon.height} <em>ft</em>
											</h3>
											<h3>
												Weight: {pokemon.weight} <em>kgs</em>
											</h3>
											<h3>
												Speed: {pokemon.stats[5].base_stat} <em>kmph</em>
											</h3>
											<h3>
												Horse Power: {pokemon.stats[0].base_stat} <em>hp</em>
											</h3>
